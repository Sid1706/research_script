...
regressor.add(LSTM(units = 35, activation='relu', return_sequences = True, input_shape = (None, 1)))
regressor.add(Dropout(.05))
# Adding a second LSTM layer
#regressor.add(LSTM(units = 90, return_sequences = True))

# Adding a third LSTM layer
regressor.add(LSTM(units = 35, activation='relu', return_sequences = True))

# Adding a fourth LSTM layer
regressor.add(LSTM(units = 35, activation= 'relu' ))
